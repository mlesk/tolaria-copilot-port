...
function explicitSwitchCommands({
  ...
  return AI_AGENT_DEFINITIONS
    ...
    .map((definition) => ({
      ...
      keywords: ['ai', 'agent', 'default', 'switch', 'claude', 'copilot', 'codex', definition.shortLabel.toLowerCase()],
      enabled: true,
  ...
  return [
    {
      ...
      group: 'Settings',
      keywords: ['ai', 'agent', 'guidance', 'restore', 'repair', 'claude', 'copilot', 'codex', 'agents'],
      enabled: true,
...
export function buildAiAgentCommands({
  ...
  const commands: CommandAction[] = [
    {
      ...
      group: 'Settings',
      keywords: ['ai', 'agent', 'agents', 'assistant', 'claude', 'copilot', 'codex', 'settings'],
  ...
  commands.push({
    ...
    group: 'Settings',
    keywords: ['ai', 'agent', 'default', 'switch', 'claude', 'copilot', 'codex'],
